...
class Pending extends StatefulWidget {
  ...
  const Pending({Key key, this.isExpired}) : super(key: key);
  @override
          ...
          ExpandChild(
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      fontSize: 16,
                      color: _themeUtils.getColor(zappStrings.TEXT_COLOUR6),
                    ),
                  ),
                  Text(
                    "Search another instructor",
                    style: TextStyle(
                      fontFamily: 'Inter',
            ...
            Container(
              ...
              decoration: BoxDecoration(
               ...
               border: Border.all(color:  _themeUtils.getColor(zappStrings.TEXT_COLOUR6)),
              ),
              child:Center(
