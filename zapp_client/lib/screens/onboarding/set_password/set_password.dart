...
class _SetPasswordScreenState extends State<SetPasswordScreen> {
  ...
  //
  SetPasswordBloc _setPasswordBloc;
  ...
  void didChangeDependencies() {
    ...
    _setPasswordBloc = Provider.of<SetPasswordBloc>(context);
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: Image.asset(PASSWORD_IMG),
                    ),
                    ...
                    Padding(
                        padding: EdgeInsets.only(top: _height * 8/812),
                        child:InkWell(
                          onTap: () => Navigator.pushNamed(context, '/setAddress'),
                          child: Container(
                            ...
                            child: Center(child: Text("Set My Password",
                              style: TextStyle(
                                fontFamily: 'Inter',
                                fontWeight: FontWeight.w600,
                                fontSize: 18,
