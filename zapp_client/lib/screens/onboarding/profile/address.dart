...
class _AddressScreenState extends State<AddressScreen> {
  ...
  //
  SetAddressBloc _setAddressBloc;
  ...
  void didChangeDependencies() {
    ...
    _setAddressBloc = Provider.of<SetAddressBloc>(context);
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: Image.asset(ADDRESS_IMG),
                    ),
                    SizedBox(height: _height*(144.02/812),),
                    Container(
                      width: _width * (325/375),
                      child: Center(
                        child: Text("Few More Steps to Complete Your Account…",
                          style: TextStyle(
                            fontFamily: 'Inter',
                    ...
                    Padding(
                        padding: EdgeInsets.only(top: _height * 100/812,left: _width * (235/375)),
                        child:InkWell(
                          onTap: () => Navigator.pushNamed(context, '/setProfileImg'),
                          child: Container(
